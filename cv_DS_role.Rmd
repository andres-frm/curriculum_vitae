...
I am a researcher with a Ph.D. in Biological Sciences and extensive experience in applying rigorous statistical methods to solve real-world problems. My expertise lies in experimental design, Bayesian inference, and causal inference—skills I have successfully applied to design strategies that optimize production and profits in pollinator-dependent crops, such as blueberries. I have a strong publication record, demonstrating my ability to generate robust, reproducible insights suitable for scientific and regulated environments. Currently, I am completing an MBA in Data Science at the University of São Paulo, where I am gaining proficiency in machine learning and AI models. My researcher’s mindset is hypothesis-driven, quantitatively rigorous, and focused on translating complex data into actionable solutions.
...
-   Machine learning: regression trees, random forests, basic deep learning (in progress via MBA).
