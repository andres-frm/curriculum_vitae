...
I am a researcher with a Ph.D. in Biological Sciences and extensive experience in applying rigorous statistical methods to solve real-world problems related to ecosystem services. My expertise lies in experimental design, Bayesian inference, and causal inference—skills I have successfully applied to design strategies that optimize production and profits in pollinator-dependent crops, such as blueberries. I have a strong publication record, demonstrating my ability to generate robust, reproducible insights suitable for scientific and regulated environments. My researcher’s mindset is hypothesis-driven, quantitatively rigorous, and focused on translating complex data into actionable solutions.
...
-   Causal inference.
-   Data analysis: frequentist and Bayesian statistics (lm, glm, glmm, hierarchical models, mixed models), Gaussian process models, time series analysis, structural equation modeling, network analysis, and simulation studies.
-   Programming languages: R (advanced), Python (intermediate), Stan (intermediate), and SQL (basic).
...
-   Mauro Galetti, **Ramírez-Mejía A. F.**, et al. Island Biogeography Shapes Fruit-Frugivore Interactions . **Role: coauthor, data analysis**
...
tribble(
  ...
  "R programming", "Universidade Federal de Pelotas", "graduate",  2024, 
...
tribble(
  ...
  2023, 'Google Earth Engine', 'REDES Center (CONICET)', 60, 'Argentina',
