...
-   Fontanarrosa G., Zarbá L., ... **Ramírez-Mejía A F** ... Piquer-Rodríguez M. Over twenty years of publications in Ecology: Over-contribution of Women reveals a new dimension of gender bias. *PLOS ONE*. **Aceptado**.
...
-   **Ramírez-Mejía A. F.**, Chacoff N., Cavigliasso P., Blendinger P., How much is enough? Optimizing beehive stocking densities to maximize the production of a pollinator-dependent crop. **Ecological modelling** (second round of revision).

-   Monasterologo, M, **Ramírez-Mejía A. F.**, et al. Animal pollination contributes to more than half of Citrus spp. production despite the species and cultivar. *Scientific reports* (second round of revision).
