...
-   Análisis de datos: estadística frecuentista y bayesiana (lm, glm glmm, modelos jerarquicos), modelos de ecuaciones estructurales, análisis de redes, lógica difuza, y modelos basados en agentes.
...
-   Otras herramientas: Git, RMarkdow y Quarto.
...
tribble(
  ...
  2017, 'MSc con mensión meritoria, Pontificia universidad Javeriana'
) |> 
  baretable()
