...
-   Causal inference.
-   Data analysis: frequentist and Bayesian statistics (lm, glm, glmm, hierarchical models), Gaussian process models, time series analysis, Bayesian networks, structural equation modeling, network analysis, and simulation studies.
